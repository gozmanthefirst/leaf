...
const Theme = ({
  ...
  const applyTheme = useStableCallback((theme) => {
    let resolved = theme;
    if (!resolved) return;
  ...
  const setTheme = useStableCallback((value) => {
  ...
  const handleMediaQuery = useStableCallback(
